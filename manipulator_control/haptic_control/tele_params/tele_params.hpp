...
namespace params
{
    ...
    private:
        ...
        Eigen::Array<double,12,1> message_;

        server::UDPServer<14,12> server_ = server::UDPServer<14,12>("127.0.0.1", 8080, "127.0.0.1", 8081);  // UDP
    ...
    public:
        ...
        ~TeleState();
        void loop(const HapicState& haptic_state);
